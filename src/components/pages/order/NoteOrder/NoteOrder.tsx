...
import notemodal from "./note.module.css";
...
export function NoteModal({ id_order, note }: NoteModalProps) {
                    ...
                    <div className="fixed inset-0 w-screen overflow-y-auto">
                        ...
                        >
                            <div className="relative transform overflow-visible transition-all">
                                ...
                                <div
                                    className={`${notemodal.noteDialog} relative bg-white overflow-visible`}
                                >
                                    <button
                                        type="button"
                                        onClick={() => {
                                    ...
                                    <div className="relative flex justify-center items-center">
                                        <textarea
                                            spellCheck="false"
                                            className={`${notemodal.noteTextArea} w-full h-full focus:border-gray-500 focus:outline-none focus:ring-0`}
