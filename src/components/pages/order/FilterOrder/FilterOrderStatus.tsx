...
import { clearFilterByStatus, setFilterByStatus } from "@/redux/slice/orderSlice";
import { statusList } from "@/functions/constant";

export default function FilterOrderStatus({ isActived }: { isActived: boolean }) {
    ...
    return (
        <div className="relative">
            ...
            >
                ...
                >
                    {filterOrderByStatus !== ""
                        ? handleFilterStatus(filterOrderByStatus)
                        : "Trạng thái"}
                </p>
