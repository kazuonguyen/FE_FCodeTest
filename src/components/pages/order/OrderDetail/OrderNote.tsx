...
export function OrderNote({ id_order, note }: OrderNoteProps) {
    ...
    return (
        <>
            <div
                role="button"
                className={`${order.orderNote} flex flex-row items-center justify-between`}
                onClick={() => {
                    setIsShowModal(true);
                }}
            >
                    ...
                    <div className="relative inset-0 w-screen overflow-y-auto">
                        ...
                        >
                            <div className="relative transform overflow-visible transition-all">
                                ...
                                <div
                                    className={`${order.noteDialog} relative bg-white overflow-visible`}
                                >
                                    <button
                                        type="button"
                                        onClick={() => {
                                    ...
                                    <div className="relative flex justify-center items-center">
                                        <textarea
                                            spellCheck="false"
                                            className={`${order.noteTextArea} w-full h-full focus:border-gray-500 focus:outline-none focus:ring-0`}
