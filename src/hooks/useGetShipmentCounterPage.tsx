...
export default function useGetCounterPage() {
    ...
    // Get counter page
    const getShipmentCounterPage = async () => {
        try {
            const res = await fetchLogistics("protected/shipment/pagenum?limit=20", {
                method: "GET",
                withToken: true,
            });
    ...
    useEffect(() => {
        getShipmentCounterPage();
    }, []);
    return { counterPage, getShipmentCounterPage };
}
